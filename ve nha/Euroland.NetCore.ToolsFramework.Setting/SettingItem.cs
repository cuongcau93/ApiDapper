...
namespace Euroland.NetCore.ToolsFramework.Setting
{
    ...
    public class SettingItem : ISettingItem
    {
        ...
        public string this[string name]
        {
            get
            {
                return _root[SettingFlatterningKeyUtil.Join(_path, name)];
            }
            set
            {
                _root[SettingFlatterningKeyUtil.Join(_path, name)] = value;
            }
        }
        ...
        {
            return _root.GetChild(SettingFlatterningKeyUtil.Join(_path, name));
        }

...
namespace Euroland.NetCore.ToolsFramework.Setting
{
    public abstract class SettingProviderBase : ISettingProvider
    {
        ...
        /// </summary>
        /// <returns></returns>
        public IChangeToken GetOnChangeToken()
        {
            return _changeToken;
        }
        ...
        {
            var prevChangeToken = System.Threading.Interlocked.Exchange<SettingChangeToken>(ref _changeToken, new SettingChangeToken());
            prevChangeToken.OnChange();
        }
